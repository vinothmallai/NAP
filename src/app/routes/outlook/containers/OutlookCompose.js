  ...
  render() {
    let ccTrigger = !this.state.cc ? <em>
      <OverlayTrigger placement="bottom"
        ...
        <a href="#" onClick={this._addCarbonCopy}>CC</a>
      </OverlayTrigger>
    </em> : null;
    ...
    let bccTrigger = !this.state.bcc ? <em>
      <OverlayTrigger placement="bottom"
        ...
        <a href="#" onClick={this._addBlindCarbonCopy}>BCC</a>
      </OverlayTrigger>
    </em> : null;
      ...
      <div className="table-wrap custom-scroll">
        ...
        <form onSubmit={this._handleSubmit} encType="multipart/form-data" className="form-horizontal">
              ...
              <div className="form-group">
                ...
                <div className="col-md-11">
                  ...
                  <OverlayTrigger placement="bottom"
                    ...
                    <em><a href="#" className="show-next" onClick={this._addAttachments}><i
          ...
          <div className="inbox-message no-padding">
            ...
            <Summernote id="emailbody"><br /><br /><span>Thanks,</span><br/><strong>John
              Doe</strong><br/><br/></Summernote>
          </div>
        ...
        <div className="email-infobox">
          ...
          <ul className="list-inline">
            ...
            <li><img src="assets/img/avatars/male.png" alt="me" width="30px"/></li>
